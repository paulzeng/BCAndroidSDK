...
public class BeSuperListView extends BeBaseSuperAbsListview {


    public BeSuperListView(Context context) {
        super(context);
    }


    public BeSuperListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BeSuperListView(Context context, AttributeSet attrs, int defStyle) {
