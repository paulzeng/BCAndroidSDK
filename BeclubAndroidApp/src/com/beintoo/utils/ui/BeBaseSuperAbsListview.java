...
public abstract class BeBaseSuperAbsListview extends FrameLayout implements AbsListView.OnScrollListener{
    ...
    public BeBaseSuperAbsListview(Context context) {
        super(context);
        initView();
    }

    public BeBaseSuperAbsListview(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public BeBaseSuperAbsListview(Context context, AttributeSet attrs, int defStyle) {
